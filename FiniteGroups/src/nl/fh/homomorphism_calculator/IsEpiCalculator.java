...
/**
 * Determines whether a homomorphism is surjective, i.e. the image is 
 * covering the codomain.
 * 
 * 
 * @author frank
 */
class IsEpiCalculator implements Calculator<GroupHomomorphism> {
    ...
    public Boolean evaluate(GroupHomomorphism morph) throws EvaluationException {
          ...
          int codomainSize = (int) codomain.getProperty(GroupProperty.Order);
          
          int image = (new HashSet(map.values())).size();
          return (codomainSize == image);
    }
