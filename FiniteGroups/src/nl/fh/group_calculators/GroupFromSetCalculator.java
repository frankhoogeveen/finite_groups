...
public class GroupFromSetCalculator implements Calculator<Group>{
    ...
    /**
     * 
     * Given a property that evaluates to a set of elements, this calculator
     * wraps that set of elements into the group generated by those elements.
     * Essentially this calculator lifts Sets to (Sub)groups.
     * 
     * @param prefix the prefix applied to the name of the original group
     * @param property a GroupProperty that evaluates to a Set<Element>
     */
